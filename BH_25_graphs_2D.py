...
def makeGraphs(makePictures=False):
  ...
  ax = Axes2D(fig)
  ax.legend()
  ax.plot(x1,z1,label="Silver")
  ax.plot(x2,z2,label="Gold")
  ax.plot(x3,z3,label="Copper")
  ax.plot(x4,z4,label="Iridium")
  ax.plot(x5,z5,label="Nickel")
  ax.plot(x6,z6,label="Palladium")
  ax.plot(x7,z7,label="Rhodium")
  ax.autoscale_view()
